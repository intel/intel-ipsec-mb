...
| AES128-CTR     | Y  by8 |  <---  |  <---  | Y  by8 | Y by16 |  <---  |  <---  | [A2-1] | Y   by16 |  <---  |
| AES192-CTR     | Y  by8 |  <---  |  <---  | Y  by8 | Y by16 |  <---  |  <---  | [A2-1] | Y   by16 |  <---  |
| AES256-CTR     | Y  by8 |  <---  |  <---  | Y  by8 | Y by16 |  <---  |  <---  | [A2-1] | Y   by16 |  <---  |
...
| ZUC-NEA6       | Y   x4 |  <---  | Y(4)x4 | Y  x8  | Y(4)x8 |  <---  |  <---  | Y  x16 | Y(4) x16 |  <---  |
...
|---+---------------------+----------------+-----------------------------------|
| 4 | AES-ECB encryption  | Avoid          | AES-GCM (AEAD); AES-CBC/AES-CTR   |
|   |                     |                | only together with an integrity   |
|   |                     |                | algorithm (e.g. HMAC-SHA256)      |
|---+---------------------+----------------+-----------------------------------|
| 5 | HMAC-SHA1 integrity | Avoid          | HMAC-SHA256                       |
+------------------------------------------------------------------------------+
```
...
|---------------------+-----------+----------------------------------------------------------|
| HMAC-SHA3-224       | FIPS198-1 | keyLen: [min = 8, max = 524288, increment = 8]           |
| (HMAC-SHA3-224)     | FIPS202   | macLen: [min = 32, max = 224, increment = 8]             |
|---------------------+-----------+----------------------------------------------------------|
| HMAC-SHA3-256       | FIPS198-1 | keyLen: [min = 8, max = 524288, increment = 8]           |
| (HMAC-SHA3-256)     | FIPS202   | macLen: [min = 32, max = 256, increment = 8]             |
|---------------------+-----------+----------------------------------------------------------|
| HMAC-SHA3-384       | FIPS198-1 | keyLen: [min = 8, max = 524288, increment = 8]           |
| (HMAC-SHA3-384)     | FIPS202   | macLen: [min = 32, max = 384, increment = 8]             |
|---------------------+-----------+----------------------------------------------------------|
| HMAC-SHA3-512       | FIPS198-1 | keyLen: [min = 8, max = 524288, increment = 8]           |
| (HMAC-SHA3-512)     | FIPS202   | macLen: [min = 32, max = 512, increment = 8]             |
|---------------------+-----------+----------------------------------------------------------|
