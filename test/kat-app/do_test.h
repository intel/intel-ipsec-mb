...
static unsigned char key[] = { 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79,
...
static unsigned char text[] = { 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x20, 0x23, 0x34 };

static unsigned char hmac12[] = { 0x9e, 0xa8, 0x86, 0xef, 0xe2, 0x68,
                                  0xdb, 0xec, 0xce, 0x42, 0x0c, 0x75 };

#define KEYSIZE  sizeof(key)
#define TEXTSIZE sizeof(text)

static unsigned char plain[] = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e,
...
static unsigned char key128[] = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
                                  0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c };

static unsigned char ic[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                              0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };

static unsigned char cipherCBC128[] = { 0x76, 0x49, 0xab, 0xac, 0x81, 0x19, 0xb2, 0x46, 0xce, 0xe9,
...
do_test(IMB_MGR *mb_mgr)
{
        ...
        for (size = 32; size < 4096; size += 16) {
                ...
                job->enc_keys = job->dec_keys = (uint32_t *) keys;
                job->src = buf;
                job->dst = buf + 20;
                job->iv = (uint8_t *) &IV;
                job->iv_len_in_bytes = 16;
