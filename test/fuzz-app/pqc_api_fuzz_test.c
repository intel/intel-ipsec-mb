...
static IMB_ARCH arch = IMB_ARCH_NONE;
static uint64_t flags = 0;

/**
 * @brief Parse the application specific arguments that follow "--":
 *        architecture selection (SSE/AVX2/AVX512/AVX10) and CPU feature
 *        disable switches.
 *
 * @param [in] argc  Number of arguments following "custom"
 * @param [in] argv  Arguments following "custom"
 */
static void
 ...
 *        arguments introduced by "custom" and hides them from libFuzzer.
 *
 * @param [in,out] argc  Argument count, truncated at the "custom" argument
