...
static uint8_t T1_CTR[] = {
};
static uint8_t A1_CTR[] = { };
#define A1_CTR_len 0
...
static uint8_t T2_CTR[] = {
};
static uint8_t A2_CTR[] = { };
#define A2_CTR_len 0
...
static uint8_t T3_CTR[] = {
};
static uint8_t A3_CTR[] = { };
#define A3_CTR_len 0
...
static uint8_t T4_CTR[] = {
};
static uint8_t A4_CTR[] = { };
#define A4_CTR_len 0
...
static uint8_t T5_CTR[] = {
};
static uint8_t A5_CTR[] = { };
#define A5_CTR_len 0
...
static uint8_t T6_CTR[] = {
};
static uint8_t A6_CTR[] = { };
#define A6_CTR_len 0
...
static uint8_t T7_CTR[] = {
};
static uint8_t A7_CTR[] = { };
#define A7_CTR_len 0
...
static uint8_t T8_CTR[] = {
};
static uint8_t A8_CTR[] = { };
#define A8_CTR_len 0
...
static uint8_t T9_CTR[] = {
};
static uint8_t A9_CTR[] = { };
#define A9_CTR_len 0

static const gcm_vector ctr_vectors[] = {
...
typedef void (*keyexp_t)(void *raw, void *enc, void *dec);
                     ...
                     struct MB_MGR *mb_mgr)
{
	...
	int vect;
	int errors = 0;
        uint32_t expkey[4*15] __attribute__((aligned(16)));
        uint32_t dust[4*15] __attribute__((aligned(16)));
	...
	for (vect = 0; ((vect < vectors_cnt) /*&& (1 == OK) */ ); vect++) {
		...
		printf(".");
                ...
                if (test_ctr(handler,
                             ...
                             ctr_vectors[vect].IV, ctr_vectors[vect].IVlen,
                             ctr_vectors[vect].P, ctr_vectors[vect].C,
                             ctr_vectors[vect].Plen,
                             ENCRYPT, CIPHER_HASH)) {
