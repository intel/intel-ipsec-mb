...
extern void
SHA3_shake256_x4_inc_absorb_avx512vl(uint64_t *state, const void *in0, const void *in1,
                                     const void *in2, const void *in3, size_t inlen);

extern void
SHA3_shake128_x4_inc_finalize_avx512vl(uint64_t *state);
extern void
SHA3_shake256_x4_inc_finalize_avx512vl(uint64_t *state);

extern void
SHA3_shake128_x4_inc_squeeze_avx512vl(void *out0, void *out1, void *out2, void *out3, size_t outlen,
                                      uint64_t *state);

extern void
SHA3_shake256_x4_inc_squeeze_avx512vl(void *out0, void *out1, void *out2, void *out3, size_t outlen,
                                      uint64_t *state);

/* One-shot assembly function declarations */
extern void
SHA3_shake128_x4_avx512vl(void *out0, void *out1, void *out2, void *out3, size_t outlen,
                          const void *in0, const void *in1, const void *in2, const void *in3,
                          size_t inlen);

extern void
SHA3_shake256_x4_avx512vl(void *out0, void *out1, void *out2, void *out3, size_t outlen,
                          const void *in0, const void *in1, const void *in2, const void *in3,
                          size_t inlen);
                                          ...
                                          const void *in2, const void *in3, size_t inlen)
{
        ...
        SHA3_shake128_x4_inc_absorb_avx512vl(ctx->A, in0, in1, in2, in3, inlen);
}
                                           ...
                                           size_t outlen, KECCAK1600_X4_CTX *ctx)
{
        ...
        SHA3_shake128_x4_inc_squeeze_avx512vl(out0, out1, out2, out3, outlen, ctx->A);
}
                                          ...
                                          const void *in2, const void *in3, size_t inlen)
{
        ...
        SHA3_shake256_x4_inc_absorb_avx512vl(ctx->A, in0, in1, in2, in3, inlen);
}
                                           ...
                                           size_t outlen, KECCAK1600_X4_CTX *ctx)
{
        ...
        SHA3_shake256_x4_inc_squeeze_avx512vl(out0, out1, out2, out3, outlen, ctx->A);
}
...
ossl_sha3_shake128_x4_avx512vl(void *out0, void *out1, void *out2, void *out3, size_t outlen,
                               ...
                               size_t inlen)
{
        SHA3_shake128_x4_avx512vl(out0, out1, out2, out3, outlen, in0, in1, in2, in3, inlen);
}
