...
typedef __owur int (*CBD_FUNC)(scalar *out, uint8_t in[ML_KEM_RANDOM_BYTES + 1], EVP_MD_CTX *mdctx,
...
static const ML_KEM_VINFO vinfo_map[3] = {
        { "ML-KEM-512", PRVKEY_BYTES(512), sizeof(struct prvkey_512_alloc), PUBKEY_BYTES(512),
          sizeof(struct pubkey_512_alloc), CTEXT_BYTES(512), VECTOR_BYTES(512), U_VECTOR_BYTES(512),
          EVP_PKEY_ML_KEM_512, ML_KEM_512_BITS, ML_KEM_512_RANK, ML_KEM_512_DU, ML_KEM_512_DV,
          ML_KEM_512_SECBITS, ML_KEM_512_SECURITY_CATEGORY },
        { "ML-KEM-768", PRVKEY_BYTES(768), sizeof(struct prvkey_768_alloc), PUBKEY_BYTES(768),
          sizeof(struct pubkey_768_alloc), CTEXT_BYTES(768), VECTOR_BYTES(768), U_VECTOR_BYTES(768),
          EVP_PKEY_ML_KEM_768, ML_KEM_768_BITS, ML_KEM_768_RANK, ML_KEM_768_DU, ML_KEM_768_DV,
          ML_KEM_768_SECBITS, ML_KEM_768_SECURITY_CATEGORY },
        { "ML-KEM-1024", PRVKEY_BYTES(1024), sizeof(struct prvkey_1024_alloc), PUBKEY_BYTES(1024),
          sizeof(struct pubkey_1024_alloc), CTEXT_BYTES(1024), VECTOR_BYTES(1024),
          U_VECTOR_BYTES(1024), EVP_PKEY_ML_KEM_1024, ML_KEM_1024_BITS, ML_KEM_1024_RANK,
          ML_KEM_1024_DU, ML_KEM_1024_DV, ML_KEM_1024_SECBITS, ML_KEM_1024_SECURITY_CATEGORY }
};
...
static const uint16_t kNTTRoots[128] = {
        0x001, 0x6c1, 0xa14, 0xcd9, 0xa52, 0x276, 0x769, 0x350, 0x426, 0x77f, 0x0c1, 0x31d, 0xae2,
        0xcbc, 0x239, 0x6d2, 0x128, 0x98f, 0x53b, 0x5c4, 0xbe6, 0x038, 0x8c0, 0x535, 0x592, 0x82e,
        0x217, 0xb42, 0x959, 0xb3f, 0x7b6, 0x335, 0x121, 0x14b, 0xcb5, 0x6dc, 0x4ad, 0x900, 0x8e5,
        0x807, 0x28a, 0x7b9, 0x9d1, 0x278, 0xb31, 0x021, 0x528, 0x77b, 0x90f, 0x59b, 0x327, 0x1c4,
        0x59e, 0xb34, 0x5fe, 0x962, 0xa57, 0xa39, 0x5c9, 0x288, 0x9aa, 0xc26, 0x4cb, 0x38e, 0x011,
        0xac9, 0x247, 0xa59, 0x665, 0x2d3, 0x8f0, 0x44c, 0x581, 0xa66, 0xcd1, 0x0e9, 0x2f4, 0x86c,
        0xbc7, 0xbea, 0x6a7, 0x673, 0xae5, 0x6fd, 0x737, 0x3b8, 0x5b5, 0xa7f, 0x3ab, 0x904, 0x985,
        0x954, 0x2dd, 0x921, 0x10c, 0x281, 0x630, 0x8fa, 0x7f5, 0xc94, 0x177, 0x9f5, 0x82a, 0x66d,
        0x427, 0x13f, 0xad5, 0x2f5, 0x833, 0x231, 0x9a2, 0xa22, 0xaf4, 0x444, 0x193, 0x402, 0x477,
        0x866, 0xad7, 0x376, 0x6ba, 0x4bc, 0x752, 0x405, 0x83e, 0xb77, 0x375, 0x86a
};
...
static const uint16_t kInverseNTTRoots[128] = {
        0x001, 0x497, 0x98c, 0x18a, 0x4c3, 0x8fc, 0x5af, 0x845, 0x647, 0x98b, 0x22a, 0x49b, 0x88a,
        0x8ff, 0xb6e, 0x8bd, 0x20d, 0x2df, 0x35f, 0xad0, 0x4ce, 0xa0c, 0x22c, 0xbc2, 0x8da, 0x694,
        0x4d7, 0x30c, 0xb8a, 0x06d, 0x50c, 0x407, 0x6d1, 0xa80, 0xbf5, 0x3e0, 0xa24, 0x3ad, 0x37c,
        0x3fd, 0x956, 0x282, 0x74c, 0x949, 0x5ca, 0x604, 0x21c, 0x68e, 0x65a, 0x117, 0x13a, 0x495,
        0xa0d, 0xc18, 0x030, 0x29b, 0x780, 0x8b5, 0x411, 0xa2e, 0x69c, 0x2a8, 0xaba, 0x238, 0xcf0,
        0x973, 0x836, 0x0db, 0x357, 0xa79, 0x738, 0x2c8, 0x2aa, 0x39f, 0x703, 0x1cd, 0x763, 0xb3d,
        0x9da, 0x766, 0x3f2, 0x586, 0x7d9, 0xce0, 0x1d0, 0xa89, 0x330, 0x548, 0xa77, 0x4fa, 0x41c,
        0x401, 0x854, 0x625, 0x04c, 0xbb6, 0xbe0, 0x9cc, 0x54b, 0x1c2, 0x3a8, 0x1bf, 0xaea, 0x4d3,
        0x76f, 0x7cc, 0x441, 0xcc9, 0x11b, 0x73d, 0x7c6, 0x372, 0xbd9, 0x62f, 0xac8, 0x045, 0x21f,
        0x9e4, 0xc40, 0x582, 0x8db, 0x9b1, 0x598, 0xa8b, 0x2af, 0x028, 0x2ed, 0x640
};
...
static const uint16_t kModRoots[128] = {
        0x011, 0xcf0, 0xac9, 0x238, 0x247, 0xaba, 0xa59, 0x2a8, 0x665, 0x69c, 0x2d3, 0xa2e, 0x8f0,
        0x411, 0x44c, 0x8b5, 0x581, 0x780, 0xa66, 0x29b, 0xcd1, 0x030, 0x0e9, 0xc18, 0x2f4, 0xa0d,
        0x86c, 0x495, 0xbc7, 0x13a, 0xbea, 0x117, 0x6a7, 0x65a, 0x673, 0x68e, 0xae5, 0x21c, 0x6fd,
        0x604, 0x737, 0x5ca, 0x3b8, 0x949, 0x5b5, 0x74c, 0xa7f, 0x282, 0x3ab, 0x956, 0x904, 0x3fd,
        0x985, 0x37c, 0x954, 0x3ad, 0x2dd, 0xa24, 0x921, 0x3e0, 0x10c, 0xbf5, 0x281, 0xa80, 0x630,
        0x6d1, 0x8fa, 0x407, 0x7f5, 0x50c, 0xc94, 0x06d, 0x177, 0xb8a, 0x9f5, 0x30c, 0x82a, 0x4d7,
        0x66d, 0x694, 0x427, 0x8da, 0x13f, 0xbc2, 0xad5, 0x22c, 0x2f5, 0xa0c, 0x833, 0x4ce, 0x231,
        0xad0, 0x9a2, 0x35f, 0xa22, 0x2df, 0xaf4, 0x20d, 0x444, 0x8bd, 0x193, 0xb6e, 0x402, 0x8ff,
        0x477, 0x88a, 0x866, 0x49b, 0xad7, 0x22a, 0x376, 0x98b, 0x6ba, 0x647, 0x4bc, 0x845, 0x752,
        0x5af, 0x405, 0x8fc, 0x83e, 0x4c3, 0xb77, 0x18a, 0x375, 0x98c, 0x86a, 0x497
};
 ...
 */
static __owur int
single_keccak(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen, EVP_MD_CTX *mdctx)
{
        ...
        return EVP_DigestFinal_ex(mdctx, out, &sz) && ossl_assert((size_t) sz == outlen);
}
 ...
 */
static __owur int
prf(uint8_t *out, size_t len, const uint8_t in[ML_KEM_RANDOM_BYTES + 1], EVP_MD_CTX *mdctx,
    const ML_KEM_KEY *key)
{
 ...
 */
static __owur int
hash_h(uint8_t out[ML_KEM_PKHASH_BYTES], const uint8_t *in, size_t len, EVP_MD_CTX *mdctx,
       const ML_KEM_KEY *key)
{
...
static int
hash_h_pubkey(uint8_t pkhash[ML_KEM_PKHASH_BYTES], EVP_MD_CTX *mdctx, ML_KEM_KEY *key)
{
 ...
 */
static __owur int
hash_g(uint8_t out[ML_KEM_SEED_BYTES], const uint8_t *in, size_t len, EVP_MD_CTX *mdctx,
       const ML_KEM_KEY *key)
{
 ...
 */
static __owur int
kdf(uint8_t out[ML_KEM_SHARED_SECRET_BYTES], const uint8_t z[ML_KEM_RANDOM_BYTES],
    const uint8_t *ctext, size_t len, EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
        return EVP_DigestInit_ex(mdctx, key->shake256_md, NULL) &&
 ...
 */
static __owur int
sample_scalar(scalar *out, EVP_MD_CTX *mdctx)
{
...
/* Forward declarations of the base (portable C, Barrett) implementations */
static void
poly_ntt_base(scalar *p);
static void
poly_ntt_inverse_base(scalar *p);
static void
poly_add_base(scalar *lhs, const scalar *rhs);
static void
poly_sub_base(scalar *lhs, const scalar *rhs);
static void
poly_mult_base(scalar *out, const scalar *lhs, const scalar *rhs);
static void
poly_mult_add_base(scalar *out, const scalar *lhs, const scalar *rhs);

/**
 * @brief Assign the base (portable C) polynomial primitives to \a self.
 *
 * @param [in,out] self  ML-KEM context to initialise
 */
void
ossl_ml_kem_poly_init_base(IMB_ML_KEM *self)
{
        ...
        self->poly_add = poly_add_base;
        self->poly_sub = poly_sub_base;
        self->poly_mult = poly_mult_base;
        self->poly_mult_add = poly_mult_add_base;
}

/**
 * @brief Assign the AVX2 polynomial primitives to \a self.
 *
 * @param [in,out] self  ML-KEM context to initialise
 */
void
...
{
        self->poly_ntt = ml_kem_ntt_avx2;
        self->poly_ntt_inverse = ml_kem_inverse_ntt_avx2;
        self->poly_add = ml_kem_add_avx2;
        self->poly_sub = ml_kem_sub_avx2;
        self->poly_mult = ml_kem_mul_avx2;
        self->poly_mult_add = ml_kem_mul_add_avx2;
}
...
static void
scalar_mult_const(scalar *s, uint16_t a)
{
 ...
 */
static void
poly_ntt_inverse_base(scalar *s)
{
 ...
 */
static void
scalar_encode_1(uint8_t out[DEGREE / 8], const scalar *s)
{
        int i, j;
        uint8_t out_byte;
...
static __owur int
scalar_decode_12(scalar *out, const uint8_t in[3 * DEGREE / 2])
{
        int i;
        uint16_t *c = out->c;
...
static void
vector_add(const IMB_ML_KEM *self, scalar *lhs, const scalar *rhs, int rank)
{
        do {
                self->poly_add(lhs++, rhs++);
        } while (--rank > 0);
}
 ...
 */
static void
vector_encode(uint8_t *out, const scalar *a, int bits, int rank)
{
 ...
 */
static void
vector_decode_decompress_ntt(const IMB_ML_KEM *self, scalar *out, const uint8_t *in, int bits,
                             int rank)
{
        int stride = bits * DEGREE / 8;
...
static __owur int
vector_decode_12(scalar *out, const uint8_t in[3 * DEGREE / 2], int rank)
{
...
static void
vector_compress(scalar *a, int bits, int rank)
{
        do {
...
static void
inner_product(const IMB_ML_KEM *self, scalar *out, const scalar *lhs, const scalar *rhs, int rank)
{
        self->poly_mult(out, lhs, rhs);
        while (--rank > 0)
                self->poly_mult_add(out, ++lhs, ++rhs);
}
 ...
 */
static void
matrix_mult_intt(const IMB_ML_KEM *self, scalar *out, const scalar *m, const scalar *a, int rank)
{
        const scalar *ar;
        int i, j;

        for (i = rank; i-- > 0; ++out) {
                self->poly_mult(out, m++, ar = a);
                for (j = rank - 1; j > 0; --j)
                        self->poly_mult_add(out, m++, ++ar);
                self->poly_ntt_inverse(out);
        }
}

/* Here, the output vector must not overlap with the inputs */
static void
matrix_mult_transpose_add(const IMB_ML_KEM *self, scalar *out, const scalar *m, const scalar *a,
                          int rank)
{
        ...
        for (i = rank; i-- > 0; ++out) {
                self->poly_mult_add(out, mr = mc++, ar = a);
                for (j = rank; --j > 0;)
                        self->poly_mult_add(out, (mr += rank), ++ar);
        }
}
 ...
 */
static __owur int
matrix_expand(EVP_MD_CTX *mdctx, ML_KEM_KEY *key)
{
        scalar *out = key->m;
 ...
 */
static __owur int
cbd_2(scalar *out, uint8_t in[ML_KEM_RANDOM_BYTES + 1], EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
        uint16_t *curr = out->c, *end = curr + DEGREE;
 ...
 */
static __owur int
cbd_3(scalar *out, uint8_t in[ML_KEM_RANDOM_BYTES + 1], EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
        uint16_t *curr = out->c, *end = curr + DEGREE;
 ...
 */
static __owur int
gencbd_vector(scalar *out, CBD_FUNC cbd, uint8_t *counter, const uint8_t seed[ML_KEM_RANDOM_BYTES],
 ...
 */
static __owur int
gencbd_vector_ntt(const IMB_ML_KEM *self, scalar *out, CBD_FUNC cbd, uint8_t *counter,
                  const uint8_t seed[ML_KEM_RANDOM_BYTES], int rank, EVP_MD_CTX *mdctx,
                  const ML_KEM_KEY *key)
{
        uint8_t input[ML_KEM_RANDOM_BYTES + 1];
        int ret = 0;
 ...
 */
static __owur int
encrypt_cpa(const IMB_ML_KEM *self, uint8_t out[ML_KEM_SHARED_SECRET_BYTES],
            const uint8_t message[DEGREE / 8], const uint8_t r[ML_KEM_RANDOM_BYTES], scalar *tmp,
            EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
        ...
        /* FIPS 203 "u" vector */
        matrix_mult_intt(self, u, key->m, y, rank);
 ...
 */
static void
decrypt_cpa(const IMB_ML_KEM *self, uint8_t out[ML_KEM_SHARED_SECRET_BYTES], const uint8_t *ctext,
            scalar *u, const ML_KEM_KEY *key)
{
        const ML_KEM_VINFO *vinfo = key->vinfo;
        scalar v, mask;
        int rank = vinfo->rank;
        ...
        vector_decode_decompress_ntt(self, u, ctext, du, rank);
        scalar_decode(&v, ctext + vinfo->u_vector_bytes, dv);
        scalar_decompress(&v, dv);
        inner_product(self, &mask, key->s, u, rank);
        self->poly_ntt_inverse(&mask);
 ...
 */
static void
encode_pubkey(uint8_t *out, const ML_KEM_KEY *key)
{
 ...
 */
static void
encode_prvkey(uint8_t *out, const ML_KEM_KEY *key)
{
        const ML_KEM_VINFO *vinfo = key->vinfo;
 ...
 */
static int
parse_pubkey(const uint8_t *in, EVP_MD_CTX *mdctx, ML_KEM_KEY *key)
{
        const ML_KEM_VINFO *vinfo = key->vinfo;

        /* Decode and check |t| */
        if (!vector_decode_12(key->t, in, vinfo->rank)) {
                ERR_raise_data(ERR_LIB_PROV, PROV_R_INVALID_KEY, "%s invalid public 't' vector",
        ...
        if (!hash_h(key->pkhash, in, vinfo->pubkey_bytes, mdctx, key) ||
            !matrix_expand(mdctx, key)) {
                ERR_raise_data(ERR_LIB_CRYPTO, ERR_R_INTERNAL_ERROR,
                               "internal error while parsing %s public key", vinfo->algorithm_name);
                return 0;
        }
        return 1;
}
 ...
 */
static int
parse_prvkey(const uint8_t *in, EVP_MD_CTX *mdctx, ML_KEM_KEY *key)
{
        const ML_KEM_VINFO *vinfo = key->vinfo;

        /* Decode and check |s|. */
        if (!vector_decode_12(key->s, in, vinfo->rank)) {
                ERR_raise_data(ERR_LIB_PROV, PROV_R_INVALID_KEY, "%s invalid private 's' vector",
                               vinfo->algorithm_name);
                return 0;
        }
        ...
        if (memcmp(key->pkhash, in, ML_KEM_PKHASH_BYTES) != 0) {
                ERR_raise_data(ERR_LIB_PROV, PROV_R_INVALID_KEY, "%s public key hash mismatch",
                               vinfo->algorithm_name);
                return 0;
        }
 ...
 */
static __owur int
genkey(const IMB_ML_KEM *self, const uint8_t seed[ML_KEM_SEED_BYTES], EVP_MD_CTX *mdctx,
       uint8_t *pubenc, ML_KEM_KEY *key)
{
        ...
        if (!matrix_expand(mdctx, key) ||
            !gencbd_vector_ntt(self, key->s, cbd_1, &counter, sigma, rank, mdctx, key) ||
            !gencbd_vector_ntt(self, key->t, cbd_1, &counter, sigma, rank, mdctx, key))
                goto end;

        /* To |e| we now add the product of transpose |m| and |s|, giving |t|. */
        matrix_mult_transpose_add(self, key->t, key->m, key->s, rank);
 ...
 */
static int
encap(const IMB_ML_KEM *self, uint8_t *ctext, uint8_t secret[ML_KEM_SHARED_SECRET_BYTES],
      const uint8_t entropy[ML_KEM_RANDOM_BYTES], scalar *tmp, EVP_MD_CTX *mdctx,
      const ML_KEM_KEY *key)
{
        ...
        ret = hash_g(Kr, input, sizeof(input), mdctx, key) &&
              encrypt_cpa(self, ctext, entropy, r, tmp, mdctx, key);
        OPENSSL_cleanse((void *) input, sizeof(input));
 ...
 */
static int
hash_kr(uint8_t *out, uint8_t *in, EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
        ...
        return (EVP_DigestInit_ex(mdctx, key->sha3_512_md, NULL) &&
                ...
                EVP_DigestFinal_ex(mdctx, out, &sz) && ossl_assert(sz == wanted));
}
 ...
 */
static int
decap(const IMB_ML_KEM *self, uint8_t secret[ML_KEM_SHARED_SECRET_BYTES], const uint8_t *ctext,
      uint8_t *tmp_ctext, scalar *tmp, EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
...
const ML_KEM_VINFO *
ossl_ml_kem_get_vinfo(int evp_type)
{
        switch (evp_type) {
 ...
 */
int
ossl_ml_kem_key_fetch_digest(ML_KEM_KEY *key, const char *propq)
{
        ...
        return (key->shake128_md != NULL && key->shake256_md != NULL && key->sha3_256_md != NULL &&
                key->sha3_512_md != NULL);
}

ML_KEM_KEY *
ossl_ml_kem_key_new(OSSL_LIB_CTX *libctx, const char *properties, int evp_type)
{
...
int
ossl_ml_kem_encode_public_key(uint8_t *out, size_t len, const ML_KEM_KEY *key)
{
        if (!ossl_ml_kem_have_pubkey(key) || len != key->vinfo->pubkey_bytes)
                return 0;
        encode_pubkey(out, key);
        return 1;
}
...
int
ossl_ml_kem_encode_private_key(uint8_t *out, size_t len, const ML_KEM_KEY *key)
{
        if (!ossl_ml_kem_have_prvkey(key) || len != key->vinfo->prvkey_bytes)
                return 0;
...
{
        if (key == NULL || ossl_ml_kem_have_pubkey(key) || ossl_ml_kem_have_seed(key) ||
...
int
ossl_ml_kem_parse_public_key(const uint8_t *in, size_t len, ML_KEM_KEY *key)
{
        ...
        if (len != vinfo->pubkey_bytes || (mdctx = EVP_MD_CTX_new()) == NULL)
                return 0;
...
int
ossl_ml_kem_parse_private_key(const uint8_t *in, size_t len, ML_KEM_KEY *key)
{
        EVP_MD_CTX *mdctx = NULL;
        const ML_KEM_VINFO *vinfo;
        int ret = 0;
        ...
        if (len != vinfo->prvkey_bytes || (mdctx = EVP_MD_CTX_new()) == NULL)
                return 0;

        /* Clear any unused seed */
        ossl_ml_kem_key_reset(key);

        if (add_storage(OPENSSL_malloc(vinfo->puballoc), OPENSSL_secure_malloc(vinfo->prvalloc), 1,
                        0, key))
...
ossl_ml_kem_genkey(const IMB_ML_KEM *self, uint8_t *pubenc, size_t publen, ML_KEM_KEY *key)
{
        ...
        if (add_storage(OPENSSL_malloc(vinfo->puballoc), OPENSSL_secure_malloc(vinfo->prvalloc), 1,
                        0, key))
                ret = genkey(self, seed, mdctx, pubenc, key);
                       ...
                       size_t slen, const uint8_t *entropy, size_t elen, const ML_KEM_KEY *key)
{
        ...
        if (ctext == NULL || clen != vinfo->ctext_bytes || shared_secret == NULL ||
            slen != ML_KEM_SHARED_SECRET_BYTES || entropy == NULL || elen != ML_KEM_RANDOM_BYTES ||
...
#define case_encap_seed(bits)                                                                      \
        {                                                                                          \
                scalar tmp[2 * ML_KEM_##bits##_RANK];                                              \
                                                                                                   \
                ret = encap(self, ctext, shared_secret, entropy, tmp, mdctx, key);                 \
                  ...
                  size_t clen, const ML_KEM_KEY *key)
{
        ...
        if (shared_secret == NULL || slen != ML_KEM_SHARED_SECRET_BYTES || ctext == NULL ||
            clen != vinfo->ctext_bytes || (mdctx = EVP_MD_CTX_new()) == NULL) {
...
int
ossl_ml_kem_pubkey_cmp(const ML_KEM_KEY *key1, const ML_KEM_KEY *key2)
{
        /*
