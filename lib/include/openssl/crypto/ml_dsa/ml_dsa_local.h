...
void
ossl_ml_dsa_poly_ntt_vec128(POLY *p);
void
ossl_ml_dsa_poly_ntt_inverse_vec128(POLY *p);
void
ossl_poly_ntt_mult_scalar_vec128(const POLY *lhs, const POLY *rhs, POLY *out);
#endif
 ...
 */
static ossl_inline ossl_unused __owur uint32_t
