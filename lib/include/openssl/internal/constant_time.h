...
constant_time_msb_32(uint32_t a);
/* Convenience method for uint64_t. */
static ossl_inline uint64_t
constant_time_msb_64(uint64_t a);
...
constant_time_lt_8(unsigned int a, unsigned int b);
/* Convenience method for uint32_t. */
static ossl_inline uint32_t
constant_time_lt_32(uint32_t a, uint32_t b);

/* Convenience method for uint64_t. */
static ossl_inline uint64_t
constant_time_lt_64(uint64_t a, uint64_t b);
...
/* Convenience method for getting an 8-bit mask. */
static ossl_inline unsigned char
constant_time_ge_8(unsigned int a, unsigned int b);
...
static ossl_inline uint32_t
constant_time_is_zero_32(uint32_t a);
...
/* Signed integers. */
static ossl_inline unsigned int
constant_time_eq_int(int a, int b);
/* Convenience method for getting an 8-bit mask. */
static ossl_inline unsigned char
...
/* Convenience method for uint32_t. */
static ossl_inline uint32_t
constant_time_select_32(uint32_t mask, uint32_t a, uint32_t b);

/* Convenience method for uint64_t. */
static ossl_inline uint64_t
constant_time_select_64(uint64_t mask, uint64_t a, uint64_t b);
...
static ossl_inline BN_ULONG
constant_time_lt_bn(BN_ULONG a, BN_ULONG b)
{
...
static ossl_inline BN_ULONG
constant_time_eq_bn(BN_ULONG a, BN_ULONG b)
{
        return constant_time_is_zero_bn(a ^ b);
}

static ossl_inline BN_ULONG
constant_time_select_bn(BN_ULONG mask, BN_ULONG a, BN_ULONG b)
{
...
static ossl_inline uint64_t
constant_time_is_zero_64(uint64_t a)
{
...
static ossl_inline unsigned char
constant_time_eq_8_s(size_t a, size_t b)
{
...
static ossl_inline int
constant_time_select_int_s(size_t mask, int a, int b)
{
...
constant_time_cond_swap_32(uint32_t mask, uint32_t *a, uint32_t *b)
{
        uint32_t xor = *a ^ *b;
 ...
 */
static ossl_inline void
constant_time_cond_swap_64(uint64_t mask, uint64_t *a, uint64_t *b)
{
        uint64_t xor = *a ^ *b;
 ...
 */
static ossl_inline void
constant_time_cond_swap_buff(unsigned char mask, unsigned char *a, unsigned char *b, size_t len)
{
        size_t i;
        unsigned char tmp;
 ...
 */
static ossl_inline void
constant_time_lookup(void *out, const void *table, size_t rowsize, size_t numrows, size_t idx)
{
        size_t i, j;
...
static ossl_inline uint32_t
constant_time_declassify_u32(uint32_t v)
{
        /*
